...
class App(tk.Tk):
    ...
    def open_file(self):
        ...
        text = open(self.default_save_file, 'r')
        all_lines = text.read()

        # for line in all_lines:
        #     print("{}".format(line.strip()))
        self.textview.insert(tk.END,all_lines)
    ...
    def _setup_menus(self):
        ...
        # add an open option
        self.file_menu.add_command(label="Open",command=self.open_file) # TODO add a binding to a function
        # add a close option
